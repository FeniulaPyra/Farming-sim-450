...
public class FarmingTutorial : MonoBehaviour
{
    ...
    public bool skillsBefore;
    public bool afterSkillOpen;
    public bool skillsAfter;
    ...
    void Start()
    {
        ...
        if (GlobalGameSaving.Instance != null)
        {
            ...
            else
            {
                ...
                tutorialBools.Add(skillsBefore);
                tutorialBools.Add(afterSkillOpen);
                tutorialBools.Add(skillsAfter);
    ...
    void Update()
    {
        if (ScenePersistence.Instance.gamePaused == false)
        {
            ...
            if (tutorialBools[19] == false && tutorialBools[20] == true)//(hybridBefore == false && hybridAfter == true)
            {
                ...
                GlobalGameSaving.Instance.tutorialBools[24] = tutorialBools[24];
